...
<body>
  ...
  <div class="overflow-hidden text-center p-4" style="background-color: rgba(229, 208, 133, 1);">
    ...
    <?
      require_once './configs/Conexao';
      require_once './classes/ProdutoDAO.class.php';
 
       //$produtoItem = ProdutoDAO::listar();

        foreach ($produtoItem as $listar) {
    ?>
      ...
      <div class="col">
        <div class="p-2 border bg-light">
          ...
          <div class="card img-fluid">
            ...
            <div class="card-body">
              <h5 class="card-title" id="nome" ><? echo $listar->nome ?></h5>
              <h1 class="card-title" id="descricao" ><? echo $listar->descricao ?></h1>
              <p class="card-text" id="valor"> R$ <? echo $listar->preco ?></p>
              <a href="telaItem.php" class="btn btn-primary mb-2">Comprar</a>
