...
<body>
  ...
  <div class="row g-2 p-2 m-3" style="background-color: rgb(255, 255, 255);">
    ...
    <p class="card-text" id="descri">Descrição: <? echo $listar->descricap?> </p>
    <p class="card-text" id="valor" >Preço: <? echo $listar->preco ?></p>
    <p class="card-text" id="peso">Peso: <? echo $listar->peso ?></p>
    <p class="card-text" id="tam">Tamanho: <? echo $listar->tamanho ?></p>
    <p class="card-text" id="largur" >Largura: <? echo $listar->largura ?></p>
    <p class="card-text" id="espessur">Espessura: <? echo $listar->espessura ?></p>
    <p class="card-text" id="medida">Medida: <? echo $listar->medida ?></p>
  </div>
  </div>
  <!--Rodapé-->
